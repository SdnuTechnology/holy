...
original_author="SdnuTechnology"
original_name="holy"
original_urlname="holy"
original_description="Awesome holy created by SdnuTechnology" 
...
then
    ...
    echo "then run 'holy' or 'python -m holy'"
else
    poetry install
    echo "Applied Flask template"
    echo "Ensure you activate your env with 'poetry shell'"
    echo "then run 'holy' or 'python -m holy' or 'poetry run holy'"
fi
